...
Asana.prototype.setApiKey = function(api_key) {
  this.api_key = 'Basic ' + new Buffer([api_key, ''].join(':')).toString('base64');
};
...
Asana.prototype._delete = function(path, body, callback) {
  body = body || '{}';
  return this._request({
    uri:path,
    method:"DELETE",
...
Asana.prototype.deleteTask = function(taskid, callback) {
    return this._delete('/tasks/'+taskid, null, callback);
}
